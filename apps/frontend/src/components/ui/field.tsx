...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn('mb-1.5 font-bold data-[variant=label]:text-sm data-[variant=legend]:text-base', className)}
      {...props}
    />
  )
}
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        'gap-2 text-sm font-bold group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug',
        className,
      )}
      {...props}
    />
